...
enum ApiString : String {
    ...
    case identityAuth =    "/smart/fixedTask/identityAuth"    //身份证+姓名认证
    case home =    "/smart/index"    //显示首页挖矿、资产、算力、排行等信息
    case powerRank =   "/smart/power/rank"    //智慧值（算力）排行
    case propertyRank =    "/smart/asset/rank"   //智果值（ipe）排行
    case inviteInfo =    "/smart/fixedTask/inviteInfo"    //邀请好友页面，包含我的邀请码，累计获得ipe数量等
    case onceTask =    "/smart/fixedTask/list"    //提升智慧页面,包含未完成任务
    case taskRecord =    "/smart/fixedTask/record"    //固定任务完成记录
    case liveAuth =    "/smart/fixedTask/liveAuth"    //人脸身份识别
    ...
    case scanResult       = "/scanRecord/find"            //扫码结果
    

    case validateMobile   =  "/register/validateMobile"  //验证手机号
    case sendMobileCode   =  "/register/sendMobileCode"  //发送验证码
    
    
    case modifiyPwd       = "/user/updatePassword"
    case personInfo       = "/user/realInfo"
    case modifiyNickName  = "/user/updateNickname"
